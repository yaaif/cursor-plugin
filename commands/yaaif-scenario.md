...
through the spec. After spec design edits, apply with
`yaaif_agent_spec_sync_to_objects`. Adopt live catalog changes only with
`yaaif_agent_spec_sync_from_objects` (explicit; not the default finish step).
