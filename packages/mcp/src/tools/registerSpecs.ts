...
function specPath(specId: string, suffix = ""): string {
  return `/api/agent-specs/${encodeURIComponent(specId)}${suffix}`;
}

export function registerSpecTools(server: McpServer, ctx: Ctx): void {
  server.registerTool(
    ...
    async ({ limit }) => {
      try {
        ...
        return ok("Listed untracked Scenario candidates.", {
          result: await ctx.api.agentJSON(
            "GET",
            `/api/agent-specs/untracked${suffix}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
  ...
  server.registerTool(
    "yaaif_agent_spec_policy_export",
    {
      description:
    ...
    async () => {
      try {
        return ok("Exported Scenario policy.", {
          document: await ctx.api.agentJSON(
            "GET",
            "/api/agent-specs/policy/export",
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ document }) => {
      try {
        return ok("Imported Scenario policy.", {
          policy: await ctx.api.agentJSON(
            "PUT",
            "/api/agent-specs/policy/import",
            { document },
          ),
        });
      } catch (e) {
    ...
    async ({ object_id, state, spec_id }) => {
      try {
        return ok(`Marked untracked object ${state}.`, {
          result: await ctx.api.agentJSON(
            "POST",
            `/api/agent-specs/untracked/${encodeURIComponent(object_id)}/resolve`,
    ...
    async ({ limit }) => {
      try {
        ...
        return ok("Completed non-destructive Scenario drift scan.", {
          result: await ctx.api.agentJSON(
            "POST",
            `/api/agent-specs/drift-scan${suffix}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async () => {
      try {
        return ok("Fetched Scenario rollout metrics.", {
          metrics: await ctx.api.agentJSON(
            "GET",
            "/api/agent-specs/rollout-metrics",
          ),
        });
      } catch (e) {
        return fail(String(e));
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      if (args.segments !== undefined) body.segments = args.segments;
      if (args.requirements !== undefined)
        body.requirements = args.requirements;
      if (args.slots !== undefined) body.slots = args.slots;
      if (args.replace_all !== undefined) body.replace_all = args.replace_all;
      try {
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      if (args.body_md !== undefined) body.body_md = args.body_md;
      ...
      try {
        return ok(`Updated scenario segment ${args.segment_key}.`, {
          spec: await ctx.api.agentJSON(
            "PUT",
            specPath(
              args.spec_id,
              `/segments/${encodeURIComponent(args.segment_key)}`,
            ),
            body,
          ),
        });
    ...
    async (args) => {
      try {
        return ok(`Bound ${args.slot_key} to ${args.entity_id}.`, {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(args.spec_id, "/bindings"),
            {
    ...
    async ({ spec_id, expected_version }) => {
      try {
        return ok("Synced scenario workflow_design.", {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/workflow-design/sync"),
            { expected_version },
          ),
        });
      } catch (e) {
    ...
    async ({ spec_id, expected_version, preview_id }) => {
      try {
        return ok("Synced scenario from catalog objects.", {
          sync: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/sync-apply"),
            { direction: "from_objects", expected_version, preview_id },
          ),
        });
      } catch (e) {
        return fail(String(e));
      ...
      try {
        return ok("Synced catalog objects from scenario.", {
          sync: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/sync-apply"),
            { direction: "to_objects", expected_version, preview_id },
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, expected_version }) => {
      try {
        return ok("Adopted catalog objects onto this scenario.", {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/adopt-created"),
            { expected_version },
          ),
        });
      } catch (e) {
    ...
    async ({ spec_id, expected_version, release_kind, release_channel, change_summary }) => {
      try {
        return ok("Published scenario revision.", {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/revisions"),
            { expected_version, release_kind: release_kind ?? "patch", release_channel: release_channel ?? "stable", change_summary: change_summary ?? "" },
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, from_revision, to_revision }) => {
      try {
        return ok("Compared Scenario releases.", {
          diff: await ctx.api.agentJSON(
            "GET",
            `${specPath(spec_id, "/revisions/compare")}?from_revision=${from_revision}&to_revision=${to_revision}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, revision, expected_version, change_summary }) => {
      try {
        return ok("Restored Scenario release as a draft.", {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, `/revisions/${revision}/restore`),
            { expected_version, change_summary: change_summary ?? "" },
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, revision, expected_version, change_summary }) => {
      try {
        return ok("Promoted Scenario release candidate.", {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, `/revisions/${revision}/promote`),
            { expected_version, change_summary: change_summary ?? "" },
          ),
        });
      } catch (e) {
  ...
  server.registerTool(
    "yaaif_agent_spec_release_provenance_record",
    {
      description:
    ...
    async ({ spec_id }) => {
      try {
        return ok("Fetched scenario readiness.", {
          readiness: await ctx.api.agentJSON(
            "GET",
            specPath(spec_id, "/readiness"),
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id }) => {
      try {
        return ok("Fetched Scenario dependency graph.", {
          graph: await ctx.api.agentJSON(
            "GET",
            specPath(spec_id, "/dependencies"),
          ),
        });
      } catch (e) {
        return fail(String(e));
      ...
      try {
        return ok(`Saved requirement ${requirement.req_key}.`, {
          spec: await ctx.api.agentJSON(
            ...
            specPath(
              spec_id,
              `/requirements/${encodeURIComponent(requirement.req_key)}`,
            ),
            {
              expected_version,
              ...requirement,
    ...
    async ({ spec_id, expected_version, req_key }) => {
      try {
        return ok(`Deleted requirement ${req_key}.`, {
          spec: await ctx.api.agentJSON(
            "DELETE",
            `${specPath(spec_id, `/requirements/${encodeURIComponent(req_key)}`)}?expected_version=${expected_version}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, expected_version, slot }) => {
      try {
        return ok(`Saved slot ${slot.slot_key}.`, {
          spec: await ctx.api.agentJSON(
            "PUT",
            specPath(spec_id, `/slots/${encodeURIComponent(slot.slot_key)}`),
            {
              expected_version,
              ...slot,
            },
    ...
    async ({ spec_id, expected_version, slot_key }) => {
      try {
        return ok(`Deleted slot ${slot_key}.`, {
          spec: await ctx.api.agentJSON(
            "DELETE",
            `${specPath(spec_id, `/slots/${encodeURIComponent(slot_key)}`)}?expected_version=${expected_version}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, direction }) => {
      try {
        return ok("Prepared Scenario sync preview.", {
          preview: await ctx.api.agentJSON(
            "GET",
            `${specPath(spec_id, "/sync-preview")}?direction=${direction}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
      ...
      try {
        return ok("Applied Scenario sync.", {
          sync: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/sync-apply"),
            { expected_version, direction, preview_id },
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id }) => {
      try {
        return ok("Fetched Scenario conflicts.", {
          conflicts: await ctx.api.agentJSON(
            "GET",
            specPath(spec_id, "/conflicts"),
          ),
        });
      } catch (e) {
        return fail(String(e));
      ...
      try {
        return ok("Resolved Scenario conflict.", {
          spec: await ctx.api.agentJSON(
            ...
            specPath(
              spec_id,
              `/conflicts/${encodeURIComponent(conflict_id)}/resolve`,
            ),
            { expected_version, resolution, merged_value: merged_value ?? "" },
          ),
        });
      } catch (e) {
        return fail(String(e));
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return ok(
          `Recorded ${args.result} evidence for ${args.requirement_key}.`,
          {
            evidence: await ctx.api.agentJSON(
              "POST",
              specPath(args.spec_id, "/evidence"),
              args,
            ),
          },
        );
    ...
    async ({
      ...
      try {
        return ok("Activated Scenario with audited override.", {
          spec: await ctx.api.agentJSON(
            "POST",
            specPath(spec_id, "/activation-override"),
            {
              expected_version,
              override_reason,
    ...
    async ({ spec_id }) => {
      try {
        return ok("Prepared Scenario adoption preview.", {
          preview: await ctx.api.agentJSON(
            "GET",
            specPath(spec_id, "/adoption-preview"),
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id }) => {
      try {
        return ok("Fetched scenario processing.", {
          processing: await ctx.api.agentJSON(
            "GET",
            specPath(spec_id, "/processing"),
          ),
        });
      } catch (e) {
        return fail(String(e));
    ...
    async ({ spec_id, hours }) => {
      ...
      try {
        return ok("Fetched scenario metrics.", {
          metrics: await ctx.api.apiJSON(
            "GET",
            `/api/metrics/agent-specs/${encodeURIComponent(spec_id)}${suffix}`,
          ),
        });
      } catch (e) {
        return fail(String(e));
