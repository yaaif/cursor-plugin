...
export function registerOpsSupportTools(server, ctx) {
    ...
    server.registerTool("yaaif_ops_session_get", {
        ...
        try {
            const result = await ctx.api.agentJSON("GET", `/api/ops/sessions/${encodeURIComponent(session_id)}`);
    ...
    server.registerTool("yaaif_ops_ambient_run_get", {
        ...
        try {
            const result = await ctx.api.agentJSON("GET", `/api/ops/ambient-runs/${encodeURIComponent(run_id)}`);
    ...
    server.registerTool("yaaif_ops_desktop_run_get", {
        ...
        try {
            const result = await ctx.api.agentJSON("GET", `/api/ops/desktop-runs/${encodeURIComponent(run_id)}`);
